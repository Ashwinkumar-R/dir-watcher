...
//Monitor options
const DEFAULT_POLL_TIME = 10000; //every 300 secs
const DEFAULT_MAGIC_WORD = "VAG_DBID" //magic string to search in file
const DEFAULT_LOOKUP_DIRECTORY = 'C:\\MFWK\\nodejs\\andrey' //Directory to monitor
...
//const DEFAULT_DB_NAME = 'dirwatcher';
//const DEFAULT_DB_TABLE = 'dir_monitor';
...
const EXCLUDE_FILES = ['.dll','.lib','.exe','.jpg','.png'];
